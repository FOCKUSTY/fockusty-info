    ...
    <>
      ...
      <div className={styles.fockusty}>
        ...
        <p>
          ...
          <MyLink href={Api.the_void.telegram_url} name="Telegram канале" /> я каждый день пишу
          что-нибудь, общаюсь в чате и люблю писать рецензии на некоторые видео и не только! Кстати!
          Этот сайт я написал полностью сам (хотя иногда и спрашивал совета у своего друга{" "}
          <MyLink href="https://lanvalird.ru" name="Валентина (клик)" />)
        </p>
        <p>
          Вообще, если быть честным, то я не самый нормальный человек, который вообще существует на
          этой планете могу сказать, что я очень странный, ведь меня не всегда понимают люди, да и я
          людей не всегда-то понимаю впрочем интересно получается даже
        </p>
        <p>
          Также я бывают довольно депрессивным в некоторое время, особенно если мне долго не дают
          побыть в одиночестве если такое случается, то я становлюсь слишком депрессивным и
          уставшим, также меня начинают раздражать люди ещё больше
        </p>
        <p>
          Несмотря на всё выше перечисленное, я вообще душка и милашка, потому что кажусь себе
          добрым, да и другим тоже. Раньше я отнекивался от этого, однако со временем я и сам начал
          себя называть добрым, вот так вот, хотя, если быть честным, то на самом деле я считаю себе
          злым, угрюмым, уродливым, страшным, ненавистным и все другие оскорбления, которые вы
          только можете придумать :)
        </p>
      </div>
    </>
  );
  ...
  return (
    <Layout currentGroup={currentGroup}>
      <div className={styles.main_info}>
        <div className={styles.info}>
          <h2 className={[styles.text, styles.info__text__h2].join(" ")} onClick={onIntervalClick}>
